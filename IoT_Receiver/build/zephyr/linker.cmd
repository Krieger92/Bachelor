...
user_dram_seg_org = (0x3ffae000 + 0x2000);
user_dram_seg_len = ((0x3ffae000 + 0x32000) - (0x3ffae000 + 0x2000));
...
MEMORY
{
  ...
  dram0_0_seg(RW): org = user_dram_seg_org + 0xdb5c,
                   len = user_dram_seg_len - 0xdb5c
...
_heap_sentry = (0x3ffae000 + 0x32000);
SECTIONS
{
 ...
 *(.rela.*)
  ...
  _iram_end_at_dram_addr = ((_iram_end > 0x400a0000) ? (0x20000 - (_iram_end - 0x400a0000) + 0x3ffe0000) : ((0x3ffe0000 + 0x20000)));
